...
Berikut adalah contoh bentuk data (JSON) yang dihasilkan oleh _seeder_ dan _factory_, yang akan diterima oleh Frontend saat memanggil API. Contoh ini sangat berguna untuk pembuatan TypeScript Interfaces, API SDK, atau Mocking di sisi klien.
